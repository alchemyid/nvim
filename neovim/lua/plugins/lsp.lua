return {
    ...
    config = function()
      ...
      cmp.setup({
        ...
        sources = cmp.config.sources({
          { name = "lazydev", group_index = 0 }, -- Set group index to 0 to skip loading lua_ls completions when lazydev runs
  ...
  -- Dev setup for Neovim Lua API (fixes "undefined global vim" and adds autocompletion)
  {
    "folke/lazydev.nvim",
